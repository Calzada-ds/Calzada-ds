...
- **Desarrollador de Inteligencia Artificial Local (RAG) | CFE**
  - Desarrollé e implementé una IA Local basada en arquitectura **RAG** (Retrieval-Augmented Generation) para garantizar la soberanía de información sensible.
  - Utilicé tecnologías como **Ollama** y **ChromaDB** para la gestión de modelos y vectores.
  - Creé el Back-End y API con **Uvicorn** y diseñé una interfaz web intuitiva con módulo de chat interactivo.
...
- **Líder de Proyecto y Desarrollador Web | Naikal.mx**
  - Lideré el rediseño del logotipo y la programación completa del nuevo sitio web (Full-Stack).
  - Desarrollé un Front-End moderno con HTML, CSS y JavaScript, y funciones Back-End con PHP.
  - Gestioné el despliegue en servidor IONOS y optimización SEO bajo metodología Scrum.
...
- **Inmersión IA** | Alura-Google (Sep 2025)
- **White Belt Lean Six Sigma** (Nov 2022)
- **Hash Basics** | TryHackMe (Jul 2024)
- **Talent Land 2025** | Participación (Abr 2025)
